...
**2.环境变量配置**<br />环境变量提供不同模式下的全局参数。<br />在项目根目录建立环境变量配置文件。
...
**3.生产环境HTML**<br />public/index.html
```html
<html>
